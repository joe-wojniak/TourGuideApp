...
public class BackpackingFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            destinations.add(new Destination(R.string.backpacking_name, R.string.backpacking_location,
                    R.string.backpacking_open, R.string.backpacking_close, R.drawable.ic_backpacking));

            destinations.add(new Destination(R.string.backpacking_name2, R.string.backpacking_location2,
                    R.string.backpacking_open2, R.string.backpacking_close2, R.drawable.ic_backpacking));

            destinations.add(new Destination(R.string.backpacking_name3, R.string.backpacking_location3,
                    R.string.backpacking_open3, R.string.backpacking_close3, R.drawable.ic_backpacking));
